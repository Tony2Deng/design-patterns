...
![image-20230410234303978](readme.assets/image-20230410234303978.png)
...
###自己理解
原型模式指的通过一个原型复制出新的与原先一样的操作，注意要避免new操作，直接从内存复制，往往效率较高。
Java中通过Cloneable接口的clone实现，但是不注意可能会导致浅拷贝。通过二进制流的方式可以轻易的实现
深拷贝但是效率较低。